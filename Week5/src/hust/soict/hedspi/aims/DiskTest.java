...
public class DiskTest {
    public static void main(String[] args) {
        ...
        orderTest.addDigitalVideoDisc(dvd1, dvd2);
        orderTest.addDigitalVideoDisc(dvd3);
        orderTest.addDigitalVideoDisc(dvd4);

        System.out.println("Total cost before : " + orderTest.totalCost());
        DigitalVideoDisc luckyItem = orderTest.getLuckyitem();
