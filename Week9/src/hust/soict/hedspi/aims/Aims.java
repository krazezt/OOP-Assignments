...
import hust.soict.hedspi.aims.factories.*;
        ...
        do {
            switch (x) {
                case 1:
                    ...
                    switch (k) {
                        case 1 :
                            listOfItems.add(new DVDFactory().createMediaItemFromConsole());
                            break;
                        case 2 :
                            listOfItems.add(new BookFactory().createMediaItemFromConsole());
                            break;
                        case 3 :
                            listOfItems.add(new CDFactory().createMediaItemFromConsole());
                            break;
                    }
                    break;
